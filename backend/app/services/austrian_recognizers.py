...
class EUDataProtectionRecognizer(PatternRecognizer):
    ...
    Geburtsdaten, IP-Adressen, Kennzeichen und Paesse sind seit 2.3.x in
    eigene semantische Recognizer ausgelagert (DateOfBirthRecognizer,
    IPAddressRecognizer, LicensePlateRecognizer, PassportRecognizer) —
    damit die KI statt eines generischen [EU_PII_X] den tatsaechlichen
    Datentyp in den Anonymisierungscodes sieht.
    """
